...
def main():
    # Create a deck of cards. Need variable to recieve what is getting returned
...
def create_deck():
    ...
    # Return the deck. Returns when executed
    return deck
...
def deal_cards(deck, number):
    ...
    for card in range(number):
        ...
        print(card)
        value = deck[card]  # deck is dictionary, card is value
        hand_value += value
